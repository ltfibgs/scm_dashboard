...
<head>
    ...
    <title>LogiChain SCM - Manajemen Gudang</title>
...
<!-- Main Content Area -->
<main class="pb-24 md:pb-8 md:pl-72 min-h-screen pt-6">
    ...
    <div class="bg-white p-6">
        ...
        <form method="POST" action="{{ route('gudang.store') }}" class="space-y-4">
            ...
            <div class="pt-4 flex justify-end gap-2 border-t border-gray-100">
                <button type="button" onclick="document.getElementById('modalTambahGudang').close()" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-semibold rounded-lg cursor-pointer">
                    Batal
                </button>
                <button type="submit" class="px-4 py-2 bg-safety-orange hover:bg-safety-orange-dark text-white text-xs font-semibold rounded-lg cursor-pointer">
                    Simpan Barang
                </button>
            </div>
        </form>
...
<dialog id="modalOpname" class="rounded-2xl shadow-2xl border-0 p-0 w-full max-w-md backdrop:bg-black/50 backdrop:backdrop-blur-sm">
    <div class="bg-white p-6">
        ...
        <form method="POST" id="formOpname" action="" class="space-y-4">
            ...
            <div class="pt-4 flex justify-end gap-2 border-t border-gray-100">
                <button type="button" onclick="document.getElementById('modalOpname').close()" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-semibold rounded-lg cursor-pointer">
                    Batal
                </button>
                <button type="submit" class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-xs font-semibold rounded-lg cursor-pointer">
                    Simpan Opname
                </button>
            </div>
        </form>
